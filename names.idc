...
static initNames(void)
{
    ...
    MakeName(0x004CA2D0, "window_init_viewport");
    ...
    MakeName(0x0052337E, "_dragWindowType");
    MakeName(0x0052337F, "_dragWidgetIndex");
    MakeName(0x00523380, "_dragScrollIndex");
    MakeName(0x00523381, "_tooltipWindowType");
    MakeName(0x00523382, "_tooltipWindowNumber");
    MakeName(0x00523384, "_tooltipWidgetIndex");
    MakeName(0x00523386, "_tooltipCursorX");
    MakeName(0x00523388, "_tooltipCursorY");
    MakeName(0x0052338A, "_tooltipTimeout");
    MakeName(0x0052338C, "tooltip_not_shown_ticks");
    MakeName(0x0052338E, "_ticksSinceDragStart");
